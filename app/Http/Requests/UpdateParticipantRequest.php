...
class UpdateParticipantRequest extends ApiRequest
{
    private $customer;
    ...
    public function rules()
    {
        return [
            ...
            'customer_relatives.*.first_name' => 'required|max:10',
            'customer_relatives.*.last_name' => 'required|max:10',
            'customer_relatives.*.relationship' => 'required|max:50',
            ...
            'bank_order' => [
                ...
                function($attribute, $value, $fail){
                    try {
                        ...
                        $bankOrders = [0];
                        $weddingCard = WeddingCard::where('wedding_id', $weddingId)
                            ->firstOrFail();
